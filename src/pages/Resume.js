...
description: ( <ul> <li>Provided technical support for hardware, software, and network issues</li> <li>Assisted users via in-person, Zoom, and phone with prompt and professional service</li> <li>Troubleshot technical issues on Windows, macOS, ChromeOS, and mobile platforms</li> <li>Collaborated with IT team members to resolve complex technical issues</li> <li>Delivered clear, step-by-step guidance to non-technical users, improving user confidence and efficiency</li> </ul>
)
},
{
title: 'Graduate Research Assistant',
dates: 'Aug 2025 - present',
description: ( <ul> <li>Created a Python script to pull school district data from EMMA (Electronic Municipal Market Access) to analyze 6-digit CUSIPs of relevance for further analysis</li> <li>Assisted in proctoring exams of 60 students</li> </ul>
)
}
]
},
...
description: ( <ul> <li>Served as a full-time tutor and mentor offering daily small-group instruction to students in geometry and algebra</li> <li>Supported students in classes as a computer science teaching assistant</li> <li>Participated after-school programming such as staffing Girls Who Code and other academic support duties</li> <li>Worked with students and teachers to set individualized and student-driven academic goals and foster student social-emotional growth</li> <li>Built community relationships through parent communication and annual school-wide events</li> </ul>
)
}
]
},
...
description: ( <ul> <li>Coordinated events and improved quality of life for residents of the International Living Center (ILC)</li> <li>Organized events every other week for 30-70 residents</li> <li>Handled budgeting year-round for programming</li> <li>Notetaker for weekly meetings</li> <li>Communicated between residents and ResLife about improvements</li> <li>Assisted other staff members and RAs with events ranging from 20 to 300 guests</li> <li>Handled numerous purchase orders and vendor communications</li> </ul>
)
},
{
title: 'CLNI-85 Instructor',
dates: 'Dec 2022 - Mar 2023',
description: ( <ul> <li>Taught CLNI-85 course on global action, social justice, and international perspectives</li> <li>Created lesson plans and presented weekly lectures to a class of 22</li> <li>Received an A+ and college credits for teaching</li> <li>Created Discord channels and facilitated student communication</li> </ul>
)
},
{
title: 'Crown College Peer Navigator',
dates: 'Sep 2021 - Dec 2021',
description: ( <ul> <li>Assisted professors with core classes</li> <li>Assisted freshmen integrating into college life and succeeding academically</li> <li>Created Discord channels and facilitated student communication</li> </ul>
)
}
]
},
...
description: ( <ul> <li>Worked on 3D Exoplanetarium project for astronomer tools</li> <li>Built database feature from scratch with React, JS, SCSS based on Figma designs</li> <li>Participated in weekly scrum meetings and agile project management</li> </ul>
)
}
]
},
...
description: ( <ul> <li>Worked on CasCon+ simulation modeling water systems and failure tests</li> <li>Designed easy-to-read documents for decision-makers</li> <li>Wrote JS script extracting PDF data into spreadsheets for analysis</li> </ul>
)
},
{
title: 'Cybersecurity Intern',
dates: 'Jun 2019 - Aug 2019',
description: ( <ul> <li>Created Python script to delete unnecessary alerts for Thinkst Canary API</li> <li>Gained Splunk Fundamentals I certification</li> </ul>
)
}
]
}
...
},
{
  ...
  cards: [
    {
      company: 'Cyber Center of Excellence: San Diego Cyber Clinic @ SDSU',
      img: ccoe,
      roles: [
        {
...
},
{
  ...
  cards: [
    {
      company: 'Americorps Segal Award',
      img: americorps,
      roles: [
        {
          title: 'Segal AmeriCorps Education Award',
          dates: 'June 2025',
          description: (
            <p>
